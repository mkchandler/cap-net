...
namespace CAPNet.Tests
{
    public class XmlCreatorTests
    {
        ...
        {
            var orangeAlertElement = XmlCreator.Create(OrangeAlert);
            ...
            Assert.Equal(Examples.OrangeAlertXml.Substring(0, 290), alertAsString.Substring(0, 290));
        }

        private static readonly Alert OrangeAlert = new Alert 
        { 
